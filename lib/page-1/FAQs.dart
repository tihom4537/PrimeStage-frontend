          ...
          child: Column(
            ...
            children: [
              ...
              _buildFaqItem(
                ...
                answer:
                'Our refund policy allows for a full refund if the booking is canceled more than 36 hours before the performance or within 5 Hours of booking initiated. If the booking is canceled between 36 and 24 hours before the performance, 70% will be refunded, and if canceled between 24 and 12 hours before the performance, 50% will be refunded. Taxes will not be refunded at any time of cancellation.You will be eligible for complete refund including taxes if the request is cancelled by the artist.',),
              _buildFaqItem(
                question: 'Will I have to provide accommodation and traveling charges for an artist separately?',
                answer:
                'If the artist’s base location is within your city (Chandigarh, which includes Tricity areas: Chandigarh, Mohali, Panchkula, Zirakpur, Kharar, Landran, and New Chandigarh), then no additional charges are required. Everything is included in the per-hour price.\nHowever, if the artist is coming from outside your city, additional accommodation and travel charges will be discussed and arranged with the event manager.',),
              _buildFaqItem(
              ...
              _buildFaqItem(
                ...
                answer:
                'All the sound systems selected during the artist booking process or separately chosen will be arranged by the PrimeStage event manager. However, if you choose to remove the sound system option during the booking, it will be your responsibility to arrange the required audio equipment.',
              ),
              _buildFaqItem(
                ...
                answer:
                'A dedicated event manager will be assigned to each booking made on PrimeStage. The event manager will handle everything, including the artist’s arrival, sound system setup, and overall event coordination to ensure everything runs smoothly. The event manager’s contact number will be provided once the booking is confirmed.',
              ),
              _buildFaqItem(
