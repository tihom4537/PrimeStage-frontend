...
class TeamMediaUploadSection extends StatefulWidget {
  ...
  @override
  State<TeamMediaUploadSection> createState() => _TeamMediaUploadSectionState();
}

class _TeamMediaUploadSectionState extends State<TeamMediaUploadSection> {
  // Image variables
  File? _image1;
  File? _image2;
  File? _image3;
  ...
  Future<void> _pickVideo2() async {
    try {
      ...
      if (pickedFile != null) {
        ...
        await _uploadVideoToS3(
            file: File(pickedFile.path),
            videoSlot: 2, // Specify this is for video slot 2
            onProgress: (progress) {
              setState(() {
  ...
  Future<void> _pickVideo3() async {
    try {
      ...
      if (pickedFile != null) {
        ...
        await _uploadVideoToS3(
            file: File(pickedFile.path),
            videoSlot: 3, // Specify this is for video slot 3
            onProgress: (progress) {
              setState(() {
  ...
  void _updateSelectedImages() {
    ...
    print('team meadia page $selectedImages');
  }
